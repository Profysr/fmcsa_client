...
const initialEnd=Math.min(start+500,end);localStorage.setItem(STORAGE.currRange,JSON.stringify({start,end:initialEnd}));saveCurrent(start);localStorage.setItem(STORAGE.rangeSetFlag,"true");location.reload()};startBtn.addEventListener("click",rangeFormAction)}
...
const style=document.createElement("style");style.textContent=`
  ...
  `;document.head.appendChild(style)}// ./src/utils/downloader.js
